...
function makeModal(uniqueId, project) {
    ...
    if (project["github"]) {
        githubLink =
            '<a href="' +
            project["github"] +
            '" class="modal-link-container" target="_blank"><div class="modal-link-live modal-link-icon"><img src="../static/images/github.svg"></div><span class="link-text">Github repo</span></a>';
    }
    if (project["live"]) {
        liveLink =
            '<a href="' +
            project["live"] +
            '" class="modal-link-container" target="_blank"><div class="modal-link-live modal-link-icon"><img src="../static/images/zap.svg"></div><span class="link-text">Live site</span></a>';
    }

    challenges = "None in particular.";
    if (project["challenges"] != "") {
        var challenges =
            '<ul class="dark-gray-text" style="list-style-type:circle;">';
